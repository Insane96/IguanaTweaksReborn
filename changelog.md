...
* Gear stats re-balance
  * Each material now covers one or more statistics. E.g. Iron is an all-around material, but durium has much higher durability but worse damage, attack speed and armor
