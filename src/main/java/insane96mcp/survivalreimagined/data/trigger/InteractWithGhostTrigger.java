...
public class InteractWithGhostTrigger extends SimpleCriterionTrigger<InteractWithGhostTrigger.TriggerInstance> {
	static final ResourceLocation ID = new ResourceLocation(SurvivalReimagined.MOD_ID, "interact_with_ghost_trigger");

	public static InteractWithGhostTrigger TRIGGER = CriteriaTriggers.register(new InteractWithGhostTrigger());
