...
public abstract class ExplosionMixin {
    ...
    private void onWaterHydrationRadius(Level level, ParticleOptions pParticleData, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
