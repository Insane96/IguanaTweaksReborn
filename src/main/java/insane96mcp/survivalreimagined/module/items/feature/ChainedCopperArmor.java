...
public class ChainedCopperArmor extends SRFeature {
	...
	private static final SRArmorMaterial CHAINED_COPPER = new SRArmorMaterial("chained_copper", 6, new int[] {1, 3, 4, 1}, 13, SoundEvents.ARMOR_EQUIP_CHAIN, 0f, 0f, () -> Ingredient.of(Items.COPPER_INGOT));
