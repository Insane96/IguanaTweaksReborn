...
public class BoneClub extends SRFeature {
	private static final ILItemTier BONE_TIER = new ILItemTier(1, 66, 2f, 1f, 9, () -> Ingredient.of(Items.BONE));

	public static final RegistryObject<Item> BONE_CLUB = SRItems.ITEMS.register("bone_club", () -> new GenericAttackItem(BONE_TIER, 5, -2.7F, new Item.Properties()));
