...
public class ToolStats extends SRFeature {
	...
	public static final ArrayList<IdTagValue> ITEM_DURABILITIES_DEFAULT = new ArrayList<>(List.of(
			...
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:iridium_sword", 877),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:iridium_pickaxe", 877),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:iridium_axe", 877),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:iridium_shovel", 877),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:iridium_hoe", 877),
	...
	public static final ArrayList<IdTagValue> TOOL_EFFICIENCIES_DEFAULT = new ArrayList<>(Arrays.asList(
			...
			new IdTagValue(IdTagMatcher.Type.TAG, "survivalreimagined:equipment/hand/tools/iron", 5d),
			new IdTagValue(IdTagMatcher.Type.TAG, "survivalreimagined:equipment/hand/tools/iridium", 5.5d),
