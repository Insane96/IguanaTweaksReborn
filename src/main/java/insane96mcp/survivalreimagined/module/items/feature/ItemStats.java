...
public class ItemStats extends SRFeature {
	...
	public static final ArrayList<IdTagValue> ITEM_DURABILITIES_DEFAULT = new ArrayList<>(List.of(
			...
			new IdTagValue(IdTagMatcher.Type.TAG, "survivalreimagined:equipment/hand/iron", 312),
			new IdTagValue(IdTagMatcher.Type.TAG, "survivalreimagined:equipment/hand/solarium", 383),
			new IdTagValue(IdTagMatcher.Type.TAG, "survivalreimagined:equipment/hand/durium", 712),
			new IdTagValue(IdTagMatcher.Type.TAG, "survivalreimagined:equipment/hand/diamond", 1951),
			new IdTagValue(IdTagMatcher.Type.TAG, "survivalreimagined:equipment/hand/soul_steel", 2945),
			new IdTagValue(IdTagMatcher.Type.TAG, "survivalreimagined:equipment/hand/keego", 1672),
			new IdTagValue(IdTagMatcher.Type.TAG, "survivalreimagined:equipment/hand/netherite", 2538),
			...
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:diamond_leggings", 263),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:diamond_boots", 228),

			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:soul_steel_helmet", 210),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:soul_steel_chestplate", 280),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:soul_steel_leggings", 263),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:soul_steel_boots", 228),

			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:keego_helmet", 132),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:keego_chestplate", 172),
			...
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:netherite_helmet", 178),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:netherite_chestplate", 237),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:netherite_leggings", 222),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:netherite_boots", 192),
	...
	public static final ArrayList<IdTagValue> TOOL_EFFICIENCIES_DEFAULT = new ArrayList<>(Arrays.asList(
			...
			new IdTagValue(IdTagMatcher.Type.TAG, "survivalreimagined:equipment/hand/tools/copper", 5d),
