...
public class ItemStats extends SRFeature {
	...
	public static final ArrayList<IdTagValue> ITEM_DURABILITIES_DEFAULT = new ArrayList<>(List.of(
			...
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:leather_helmet", 15),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:leather_chestplate", 24),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:leather_leggings", 21),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:leather_boots", 12),

			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:chainmail_helmet", 30),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:chainmail_chestplate", 48),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:chainmail_leggings", 42),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:chainmail_boots", 91),

			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:chained_copper_helmet", 30),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:chained_copper_chestplate", 48),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:chained_copper_leggings", 42),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:chained_copper_boots", 24),

			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:iron_helmet", 60),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:iron_chestplate", 96),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:iron_leggings", 84),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:iron_boots", 48),

			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:mithril_helmet", 80),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:mithril_chestplate", 128),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:mithril_leggings", 112),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:mithril_boots", 64),

			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:golden_helmet", 60),
			...
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:golden_boots", 48),

			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:diamond_helmet", 165),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:diamond_chestplate", 264),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:diamond_leggings", 231),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:diamond_boots", 132),

			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:soul_steel_helmet", 228),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:soul_steel_chestplate", 365),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:soul_steel_leggings", 319),
			new IdTagValue(IdTagMatcher.Type.ID, "survivalreimagined:soul_steel_boots", 182),

			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:netherite_helmet", 278),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:netherite_chestplate", 445),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:netherite_leggings", 389),
			new IdTagValue(IdTagMatcher.Type.ID, "minecraft:netherite_boots", 222)
	));
