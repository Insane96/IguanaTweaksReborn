...
public class Copper extends Feature {
	...
	public Copper(Module module, boolean enabledByDefault, boolean canBeDisabled) {
		...
		IntegratedDataPacks.INTEGRATED_DATA_PACKS.add(new IntegratedDataPacks.IntegratedDataPack(PackType.SERVER_DATA, "copper_smelting", net.minecraft.network.chat.Component.literal("Survival Reimagined Copper Smelting"), () -> this.isEnabled() && copperSmeltingDataPack));
	}
}
