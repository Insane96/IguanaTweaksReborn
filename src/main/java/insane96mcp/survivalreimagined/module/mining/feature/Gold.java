...
public class Gold extends Feature {
	...
	public Gold(Module module, boolean enabledByDefault, boolean canBeDisabled) {
		...
		IntegratedDataPack.INTEGRATED_DATA_PACKS.add(new IntegratedDataPack(PackType.SERVER_DATA, "gold_equipment_crafting", net.minecraft.network.chat.Component.literal("Survival Reimagined Gold Equipment Crafting"), () -> this.isEnabled() && equipmentCraftingDataPack));
		IntegratedDataPack.INTEGRATED_DATA_PACKS.add(new IntegratedDataPack(PackType.SERVER_DATA, "gold_smelting", net.minecraft.network.chat.Component.literal("Survival Reimagined Gold Smelting"), () -> this.isEnabled() && goldSmeltingDataPack));
	}
}
