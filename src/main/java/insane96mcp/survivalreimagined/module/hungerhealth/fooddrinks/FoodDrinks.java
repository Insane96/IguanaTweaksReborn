...
public class FoodDrinks extends SRFeature {
	...
	public static String eatingSpeedFormula = "MAX((24 * effectiveness^1.35) / IF(fast_food, 2, 1) * 0.04, IF(fast_food, 16, 24))"; //max((32 * x^1.35) * 0.04, 32) or, if the food is fast eat max((32 * x^1.35) / 2 * 0.04, 32 / 2)
	@Config
