...
public class StackReductionFeature extends ITFeature {
    ...
    public void processFoodStackSizes() {
        ...
        for (CustomStackSize defaultStackSize : Modules.stackSizeModule.defaultStackSizes) {
            ...
            LogHelper.Info("item: " + item.getRegistryName() + " hunger: " + hunger + " saturation: " + saturation + " stacksize: " + stackSize + " 1: " + (1d / Math.max(saturation * 2d, 1d)) + " 2: " + (3d * (-hunger) + 64d - Math.sqrt(hunger)));
