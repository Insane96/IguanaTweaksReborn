...
import insane96mcp.iguanatweaksreborn.module.items.feature.FlintTools;
...
public class ITRecipeProvider extends RecipeProvider implements IConditionBuilder {
    public ITRecipeProvider(PackOutput p_248933_) {
        super(p_248933_);
    }
