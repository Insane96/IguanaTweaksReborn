...
import insane96mcp.iguanatweaksreborn.module.mining.forging.ForgeRecipeBuilder;
...
import insane96mcp.iguanatweaksreborn.module.mining.multiblockfurnaces.data.MultiItemSmeltingRecipeBuilder;
...
public class SRRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> writer) {
        ...
        ConditionalRecipe.builder()
                ...
                .build(writer, IguanaTweaksReborn.MOD_ID, "flint_from_gravel");
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, Items.CHAINMAIL_HELMET)
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "chainmail_helmet");
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, Items.CHAINMAIL_CHESTPLATE)
                ...
                .unlockedBy("has_cloth", has(Cloth.CLOTH.get()))
                .unlockedBy("has_chain", has(Items.CHAIN))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "chainmail_chestplate");
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, Items.CHAINMAIL_LEGGINGS)
                ...
                .unlockedBy("has_cloth", has(Cloth.CLOTH.get()))
                .unlockedBy("has_chain", has(Items.CHAIN))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "chainmail_leggings");
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, Items.CHAINMAIL_BOOTS)
                ...
                .unlockedBy("has_cloth", has(Cloth.CLOTH.get()))
                .unlockedBy("has_chain", has(Items.CHAIN))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "chainmail_boots");
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_AXE), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.TOOLS, Solarium.AXE.get())
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_axe");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_PICKAXE), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.TOOLS, Solarium.PICKAXE.get())
                .unlocks("has_solarium_moss_ball", has(Solarium.SOLARIUM_BALL.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_pickaxe");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_SHOVEL), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.TOOLS, Solarium.SHOVEL.get())
                .unlocks("has_solarium_moss_ball", has(Solarium.SOLARIUM_BALL.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_shovel");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_HOE), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.TOOLS, Solarium.HOE.get())
                .unlocks("has_solarium_moss_ball", has(Solarium.SOLARIUM_BALL.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_hoe");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_SWORD), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.COMBAT, Solarium.SWORD.get())
                .unlocks("has_solarium_moss_ball", has(Solarium.SOLARIUM_BALL.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_sword");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.SHIELD), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.COMBAT, Solarium.SHIELD.get())
                .unlocks("has_solarium_moss_ball", has(Solarium.SOLARIUM_BALL.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_shield");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_HELMET), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.COMBAT, Solarium.HELMET.get())
                .unlocks("has_solarium_moss_ball", has(Solarium.SOLARIUM_BALL.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_helmet");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_CHESTPLATE), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.COMBAT, Solarium.CHESTPLATE.get())
                .unlocks("has_solarium_moss_ball", has(Solarium.SOLARIUM_BALL.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_chestplate");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_LEGGINGS), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.COMBAT, Solarium.LEGGINGS.get())
                .unlocks("has_solarium_moss_ball", has(Solarium.SOLARIUM_BALL.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_leggings");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_BOOTS), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.COMBAT, Solarium.BOOTS.get())
                .unlocks("has_solarium_moss_ball", has(Solarium.SOLARIUM_BALL.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_boots");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Durium.INGOT.get(), 9)
                ...
                .unlockedBy("has_ingot", has(Durium.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_ingot_from_block");
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Durium.INGOT.get(), 1)
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_ingot_from_nuggets");
        ...
        MultiItemSmeltingRecipeBuilder.blasting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_ingot_from_blasting");
        MultiItemSmeltingRecipeBuilder.soulBlasting(
                ...
                .outputIncrease(0.2f)
                .unlockedBy("has_scrap_block", has(Durium.SCRAP_BLOCK.item().get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_ingot_from_soul_blasting");
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_AXE), Ingredient.of(Durium.INGOT.get()), RecipeCategory.TOOLS, Durium.AXE.get())
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_axe");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_PICKAXE), Ingredient.of(Durium.INGOT.get()), RecipeCategory.TOOLS, Durium.PICKAXE.get())
                .unlocks("has_durium", has(Durium.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_pickaxe");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_SHOVEL), Ingredient.of(Durium.INGOT.get()), RecipeCategory.TOOLS, Durium.SHOVEL.get())
                .unlocks("has_durium", has(Durium.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_shovel");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_HOE), Ingredient.of(Durium.INGOT.get()), RecipeCategory.TOOLS, Durium.HOE.get())
                .unlocks("has_durium", has(Durium.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_hoe");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_SWORD), Ingredient.of(Durium.INGOT.get()), RecipeCategory.COMBAT, Durium.SWORD.get())
                .unlocks("has_durium", has(Durium.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_sword");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.SHIELD), Ingredient.of(Durium.INGOT.get()), RecipeCategory.COMBAT, Durium.SHIELD.get())
                .unlocks("has_durium", has(Durium.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_shield");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_HELMET), Ingredient.of(Durium.INGOT.get()), RecipeCategory.COMBAT, Durium.HELMET.get())
                .unlocks("has_durium", has(Durium.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_helmet");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_CHESTPLATE), Ingredient.of(Durium.INGOT.get()), RecipeCategory.COMBAT, Durium.CHESTPLATE.get())
                .unlocks("has_durium", has(Durium.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_chestplate");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_LEGGINGS), Ingredient.of(Durium.INGOT.get()), RecipeCategory.COMBAT, Durium.LEGGINGS.get())
                .unlocks("has_durium", has(Durium.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_leggings");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Items.IRON_BOOTS), Ingredient.of(Durium.INGOT.get()), RecipeCategory.COMBAT, Durium.BOOTS.get())
                .unlocks("has_durium", has(Durium.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_boots");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Keego.GEM.get(), 9)
                ...
                .unlockedBy("has_keego", has(Keego.GEM.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "keego_from_block");
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.DIAMOND_AXE), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.TOOLS, SoulSteel.AXE.get())
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_axe");
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.DIAMOND_PICKAXE), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.TOOLS, SoulSteel.PICKAXE.get())
                .unlocks("has_soul_steel", has(SoulSteel.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_pickaxe");
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.DIAMOND_SHOVEL), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.TOOLS, SoulSteel.SHOVEL.get())
                .unlocks("has_soul_steel", has(SoulSteel.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_shovel");
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.DIAMOND_HOE), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.TOOLS, SoulSteel.HOE.get())
                .unlocks("has_soul_steel", has(SoulSteel.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_hoe");
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.DIAMOND_SWORD), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.COMBAT, SoulSteel.SWORD.get())
                .unlocks("has_soul_steel", has(SoulSteel.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_sword");
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.SHIELD), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.COMBAT, SoulSteel.SHIELD.get())
                .unlocks("has_soul_steel", has(SoulSteel.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_shield");
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.DIAMOND_HELMET), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.COMBAT, SoulSteel.HELMET.get())
                .unlocks("has_soul_steel", has(SoulSteel.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_helmet");
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.DIAMOND_CHESTPLATE), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.COMBAT, SoulSteel.CHESTPLATE.get())
                .unlocks("has_soul_steel", has(SoulSteel.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_chestplate");
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.DIAMOND_LEGGINGS), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.COMBAT, SoulSteel.LEGGINGS.get())
                .unlocks("has_soul_steel", has(SoulSteel.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_leggings");
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.DIAMOND_BOOTS), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.COMBAT, SoulSteel.BOOTS.get())
                .unlocks("has_soul_steel", has(SoulSteel.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_boots");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, SoulSteel.INGOT.get(), 9)
                ...
                .unlockedBy("has_ingot", has(SoulSteel.INGOT.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_ingot_from_block");
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, SoulSteel.INGOT.get(), 1)
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_ingot_from_nuggets");
        ...
        MultiItemSmeltingRecipeBuilder.blasting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_ingot_from_blasting");
        MultiItemSmeltingRecipeBuilder.soulBlasting(
                        NonNullList.of(Ingredient.EMPTY, Ingredient.of(Durium.INGOT.get()), Ingredient.of(Durium.INGOT.get()), Ingredient.of(CoalFire.HELLISH_COAL.get()), Ingredient.of(Items.SOUL_SAND, Items.SOUL_SOIL)),
                        RecipeCategory.MISC,
                        SoulSteel.INGOT.get(),
                ...
                .outputIncrease(0.2f)
                .unlockedBy("has_hellish_coal", has(CoalFire.HELLISH_COAL.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_ingot_from_soul_blasting");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, Items.CYAN_DYE)
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "cyan_dye_from_cyan_flower");
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "copper_ingot_from_smelting_rock");
        SimpleCookingRecipeBuilder.blasting(
                ...
                .unlockedBy("has_copper_ore_rock", has(OreGeneration.COPPER_ORE_ROCK.item().get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "copper_ingot_from_blasting_rock");
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "iron_ingot_from_smelting_rock");
        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(OreGeneration.IRON_ORE_ROCK.item().get()),
                        RecipeCategory.MISC,
                        Items.IRON_INGOT,
                ...
                .unlockedBy("has_iron_ore_rock", has(OreGeneration.IRON_ORE_ROCK.item().get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "iron_ingot_from_blasting_rock");
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "gold_ingot_from_smelting_rock");
        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(OreGeneration.GOLD_ORE_ROCK.item().get()),
                        RecipeCategory.MISC,
                        Items.GOLD_INGOT,
                ...
                .unlockedBy("has_gold_ore_rock", has(OreGeneration.GOLD_ORE_ROCK.item().get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "gold_ingot_from_blasting_rock");
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "smelting_chained_copper_helmet");
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "smelting_chained_copper_chestplate");
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "smelting_chained_copper_leggings");
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "smelting_chained_copper_boots");
        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(ChainedCopperArmor.HELMET.get()),
                        RecipeCategory.MISC,
                        Items.IRON_NUGGET,
                ...
                .unlockedBy("has_chained_armor", has(ChainedCopperArmor.HELMET.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "blasting_chained_copper_helmet");
        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(ChainedCopperArmor.CHESTPLATE.get()),
                        RecipeCategory.MISC,
                        Items.IRON_NUGGET,
                ...
                .unlockedBy("has_chained_armor", has(ChainedCopperArmor.CHESTPLATE.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "blasting_chained_copper_chestplate");
        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(ChainedCopperArmor.LEGGINGS.get()),
                        RecipeCategory.MISC,
                        Items.IRON_NUGGET,
                ...
                .unlockedBy("has_chained_armor", has(ChainedCopperArmor.LEGGINGS.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "blasting_chained_copper_leggings");
        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(ChainedCopperArmor.BOOTS.get()),
                        RecipeCategory.MISC,
                        Items.IRON_NUGGET,
                ...
                .unlockedBy("has_chained_armor", has(ChainedCopperArmor.BOOTS.get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "blasting_chained_copper_boots");
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_scrap_piece_from_smelting_ore");
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_scrap_piece_from_smelting_deepslate_ore");
        ...
        SimpleCookingRecipeBuilder.blasting(
                ...
                .unlockedBy("has_durium_ore", has(Durium.ORE.item().get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_scrap_piece_from_blasting_ore");
        ...
        SimpleCookingRecipeBuilder.blasting(
                ...
                .unlockedBy("has_durium_ore", has(Durium.DEEPSLATE_ORE.item().get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_scrap_piece_from_blasting_deepslate_ore");
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "hellish_coal_from_smelting_soul_sand_ore");
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "hellish_coal_from_smelting_soul_soil_ore");
        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(CoalFire.SOUL_SAND_HELLISH_COAL_ORE.item().get()),
                        RecipeCategory.MISC,
                        CoalFire.HELLISH_COAL.get(),
                ...
                .unlockedBy("has_hellish_coal_ore", has(CoalFire.SOUL_SAND_HELLISH_COAL_ORE.item().get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "hellish_coal_from_blasting_soul_sand_ore");
        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(CoalFire.SOUL_SOIL_HELLISH_COAL_ORE.item().get()),
                        RecipeCategory.MISC,
                        CoalFire.HELLISH_COAL.get(),
                ...
                .unlockedBy("has_hellish_coal_ore", has(CoalFire.SOUL_SOIL_HELLISH_COAL_ORE.item().get()))
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "hellish_coal_from_blasting_soul_soil_ore");
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Forging.IRON_HAMMER.get()), Ingredient.of(Solarium.SOLARIUM_BALL.get()), RecipeCategory.TOOLS, Forging.SOLARIUM_HAMMER.get())
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "solarium_hammer");
        SmithingTransformRecipeBuilder.smithing(Ingredient.EMPTY, Ingredient.of(Forging.IRON_HAMMER.get()), Ingredient.of(Durium.INGOT.get()), RecipeCategory.TOOLS, Forging.DURIUM_HAMMER.get())
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "durium_hammer");
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(SoulSteel.UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Forging.IRON_HAMMER.get()), Ingredient.of(SoulSteel.INGOT.get()), RecipeCategory.TOOLS, Forging.SOUL_STEEL_HAMMER.get())
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_steel_hammer");
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), Ingredient.of(Forging.DIAMOND_HAMMER.get()), Ingredient.of(Items.NETHERITE_INGOT), RecipeCategory.TOOLS, Forging.NETHERITE_HAMMER.get())
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "netherite_hammer");
    ...
    private void addPoorRichOreRecipes(Consumer<FinishedRecipe> writer, OreGeneration.PoorRichOre poorRichOre, Item smeltOutput, float experience) {
        for (Item item : poorRichOre.getAllItems()) {
            ...
            SimpleCookingRecipeBuilder.smelting(
                    ...
                    .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "ingot_from_smelting_" + name);
            SimpleCookingRecipeBuilder.blasting(
                            Ingredient.of(item),
                            RecipeCategory.MISC,
                            smeltOutput,
                    ...
                    .unlockedBy("has_" + name, has(item))
                    .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "ingot_from_blasting_" + name);
        }
    }
    ...
    private void recycleGearBlasting(Consumer<FinishedRecipe> writer, Item itemToRecycle, Item output, int baseCookingTime, int amountAtMaxDurability) {
        MultiItemSmeltingRecipeBuilder.blasting(
                ...
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "blast_furnace/recycle_" + ForgeRegistries.ITEMS.getKey(itemToRecycle).getPath());
        ...
        MultiItemSmeltingRecipeBuilder.soulBlasting(
                ...
                .unlockedBy("has_armor", has(itemToRecycle))
                .group("recycle_" + ForgeRegistries.ITEMS.getKey(output).getPath())
                .save(writer, IguanaTweaksReborn.RESOURCE_PREFIX + "soul_furnace/recycle_" + ForgeRegistries.ITEMS.getKey(itemToRecycle).getPath());
    }
