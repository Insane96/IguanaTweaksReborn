...
public class SRItemModelsProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        for (String poorRichOre : poorRichOres) {
            withExistingParent("poor_%s_ore".formatted(poorRichOre), new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/poor_%s_ore".formatted(poorRichOre)));
            withExistingParent("rich_%s_ore".formatted(poorRichOre), new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/rich_%s_ore".formatted(poorRichOre)));
            withExistingParent("poor_deepslate_%s_ore".formatted(poorRichOre), new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/poor_deepslate_%s_ore".formatted(poorRichOre)));
            withExistingParent("rich_deepslate_%s_ore".formatted(poorRichOre), new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/rich_deepslate_%s_ore".formatted(poorRichOre)));
        }
        ...
        withExistingParent("soul_steel_block", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/soul_steel_block"));
        withExistingParent("blast_furnace", new ResourceLocation("block/blast_furnace"));
        withExistingParent("soul_blast_furnace", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/soul_blast_furnace"));
        ...
        withExistingParent("flint_block", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/flint_block"));
        withExistingParent("polished_flint_block", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/polished_flint_block"));
        ...
        withExistingParent("charcoal_layer", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/charcoal_layer/height_2"));

        withExistingParent("crate", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/crate"));
        ...
        withExistingParent("keego_ore", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/keego_ore"));
        withExistingParent("keego_block", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/keego_block"));
        ...
        withExistingParent("durium_block", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/durium_block"));
        withExistingParent("deepslate_durium_ore", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/deepslate_durium_ore"));
        withExistingParent("durium_ore", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/durium_ore"));
        withExistingParent("durium_scrap_block", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/durium_scrap_block"));
        ...
        basicItemWithTexture(Minecarts.NETHER_INFUSED_POWERED_RAIL.item().get(), new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/nether_infused_powered_rail"));
        ...
        withExistingParent("explosive_barrel", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/explosive_barrel"));

        withExistingParent("respawn_obelisk", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/respawn_obelisk_disabled"));

        withExistingParent("rich_farmland", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/rich_farmland"));

        basicItem(CoalFire.FIRESTARTER.get());
        basicItem(CoalFire.HELLISH_COAL.get());
        withExistingParent("soul_sand_hellish_coal_ore", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/soul_sand_hellish_coal_ore"));
        withExistingParent("soul_soil_hellish_coal_ore", new ResourceLocation(IguanaTweaksReborn.MOD_ID, "block/soul_soil_hellish_coal_ore"));
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = IguanaTweaksReborn.MOD_ID; // Change this to your mod id
