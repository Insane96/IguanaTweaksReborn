...
public class Strings {
	...
	public static class AttributeModifiers {
		...
		public static final String WEATHER_SLOWDOWN = IguanaTweaksReborn.RESOURCE_PREFIX + "weather_slowdown";
	...
	public static class Translatable {
		...
		public static final String NO_SPAWN_POINT = IguanaTweaksReborn.MOD_ID + ".no_spawn_point";
	}
}
