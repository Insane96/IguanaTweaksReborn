...
public class Config {
	...
	public static class CommonConfig {
		...
		public static class Farming {
			...
			public static String comment = "For all your nerfed farming needs";

			public ForgeConfigSpec.ConfigValue<NerfedBonemeal> nerfedBonemeal;
			...
			public Farming(ForgeConfigSpec.Builder builder) {
				...
				nerfedBonemeal = builder
						...
						.defineEnum("Nerfed Bonemeal", NerfedBonemeal.NERFED);
