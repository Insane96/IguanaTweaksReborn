...
import insane96mcp.iguanatweaksreborn.module.items.solarium.SoliumBoulderFeature;
import insane96mcp.iguanatweaksreborn.module.world.coalfire.PilableFallingLayerEntity;
import insane96mcp.iguanatweaksreborn.module.world.oregeneration.BeegOreVeinFeature;
import insane96mcp.iguanatweaksreborn.module.world.oregeneration.OreWithRandomPatchConfiguration;
import insane96mcp.iguanatweaksreborn.module.world.oregeneration.RandomBlockTagMatchTest;
...
public class SRRegistries {
    ...
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> INJECT_LOOT_MODIFIER = GLOBAL_LOOT_MODIFIER_SERIALIZERS.register("inject_loot_table", InjectLootTableModifier.CODEC);
