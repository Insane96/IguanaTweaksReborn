...
public class SleepingEffects extends Feature {
	...
	private final List<String> effectsOnWakeUpDefault = List.of("minecraft:slowness,400,0", "minecraft:weakness,300,1", "minecraft:mining_fatigue,300,1");
	...
	public SleepingEffects(Module module) {
		...
		hungerDepletedOnWakeUpConfig = ITCommonConfig.builder
		...
		effectsOnWakeUpConfig = ITCommonConfig.builder
		...
		noSleepIfHungryConfig = ITCommonConfig.builder
