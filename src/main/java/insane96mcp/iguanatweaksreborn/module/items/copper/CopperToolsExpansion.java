...
import insane96mcp.iguanatweaksreborn.data.generator.SRDamageTypeTagsProvider;
import insane96mcp.iguanatweaksreborn.module.Modules;
import insane96mcp.iguanatweaksreborn.network.NetworkHandler;
import insane96mcp.iguanatweaksreborn.network.message.ElectrocutionParticleMessage;
...
public class CopperToolsExpansion extends Feature {
	public static final TagKey<Item> COPPER_TOOLS_EQUIPMENT = TagKey.create(Registries.ITEM, new ResourceLocation(IguanaTweaksReborn.MOD_ID, "equipment/hand/tools/copper"));
	public static final TagKey<Item> COATED_EQUIPMENT = TagKey.create(Registries.ITEM, new ResourceLocation(IguanaTweaksReborn.MOD_ID, "equipment/coated_copper"));
	...
	public static final RegistryObject<SoundEvent> ELECTROCUTION = SRRegistries.SOUND_EVENTS.register("electrocution", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(IguanaTweaksReborn.MOD_ID, "electrocution")));
	...
	public static final String COATED_TIMES_HIT = IguanaTweaksReborn.RESOURCE_PREFIX + "coated_times_hit";
	public static ResourceKey<DamageType> ELECTROCUTION_ATTACK = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(IguanaTweaksReborn.MOD_ID, "electrocution_attack"));
	...
	public void onTooltip(ItemTooltipEvent event) {
		...
		//event.getToolTip().add(Component.translatable("iguanatweaksreborn.electrocution.damage", event.getEntity().getAttributeValue(Attributes.ATTACK_DAMAGE) * 1.5f).withStyle(ChatFormatting.DARK_GREEN));
		event.getToolTip().add(Component.translatable("iguanatweaksreborn.electrocution.charge", Math.round(hits / 3f * 100f)).withStyle(ChatFormatting.DARK_GRAY));
	}
}