...
public class StackSizes extends JsonFeature {
	...
	public StackSizes(Module module, boolean enabledByDefault, boolean canBeDisabled) {
        ...
        addSyncType(new ResourceLocation(IguanaTweaksReborn.MOD_ID, "custom_stack_sizes"), new SyncType(json -> loadAndReadJson(json, customStackList, CUSTOM_STACK_LIST_DEFAULT, IdTagValue.LIST_TYPE)));
        JSON_CONFIGS.add(new JsonConfig<>("custom_stack_sizes.json", customStackList, CUSTOM_STACK_LIST_DEFAULT, IdTagValue.LIST_TYPE, StackSizes::processCustomStackSizes, true, new ResourceLocation(IguanaTweaksReborn.MOD_ID, "custom_stack_sizes")));
    }
