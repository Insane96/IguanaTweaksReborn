...
public class Livestock extends JsonFeature {
	...
	public static final ArrayList<LivestockData> GROWTH_SLOWNDOWN_DEFAULT = new ArrayList<>(List.of(
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "breedable_animals"), 2.5d, Season.SPRING),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "breedable_animals"), 2.0d, Season.SUMMER),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "breedable_animals"), 3.0d, Season.AUTUMN),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "breedable_animals"), 4.0d, Season.WINTER),
	...
	public static final ArrayList<LivestockData> EGG_LAY_SLOWDOWN_DEFAULT = new ArrayList<>(List.of(
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "chickens"), 2.5d, Season.SPRING),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "chickens"), 2.0d, Season.SUMMER),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "chickens"), 3.0d, Season.AUTUMN),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "chickens"), 4.0d, Season.WINTER)
	));
	...
	public static final ArrayList<LivestockData> COW_MILK_COOLDOWN_DEFAULT = new ArrayList<>(List.of(
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "cows"), 1500, Season.SPRING),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "cows"), 1200, Season.SUMMER),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "cows"), 1800, Season.AUTUMN),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "cows"), 3000, Season.WINTER)
	));
	...
	public static final ArrayList<LivestockData> BREEDING_FAIL_CHANCE_DEFAULT = new ArrayList<>(List.of(
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "breedable_animals"), 0.6d, Season.SPRING),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "breedable_animals"), 0.5d, Season.SUMMER),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "breedable_animals"), 0.7d, Season.AUTUMN),
			new LivestockData(IdTagMatcher.newTag(IguanaTweaksReborn.RESOURCE_PREFIX + "breedable_animals"), 0.9d, Season.WINTER),
