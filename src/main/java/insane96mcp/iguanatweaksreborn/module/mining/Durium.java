...
Durium extends Feature {
	...
	private static final SRArmorMaterial ARMOR_MATERIAL = new SRArmorMaterial("iguanatweaksreborn:durium", 20, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266652_) -> {
