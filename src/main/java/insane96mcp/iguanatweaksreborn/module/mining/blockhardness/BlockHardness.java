...
import insane96mcp.iguanatweaksreborn.network.message.GlobalHardnessSyncMessage;
...
public class BlockHardness extends JsonFeature {
	...
	public static final ArrayList<IdTagValue> CUSTOM_HARDNESSES_DEFAULT = new ArrayList<>(List.of(
			...
			IdTagValue.newId("iguanatweaksreborn:poor_copper_ore", 1.667d),
			IdTagValue.newId("iguanatweaksreborn:poor_iron_ore", 2d),
			IdTagValue.newId("iguanatweaksreborn:poor_gold_ore", 2.333d),
			IdTagValue.newId("iguanatweaksreborn:rich_copper_ore", 3.333d),
			IdTagValue.newId("iguanatweaksreborn:rich_iron_ore", 4d),
			IdTagValue.newId("iguanatweaksreborn:rich_gold_ore", 4.6666d),
			...
			IdTagValue.newId("iguanatweaksreborn:poor_deepslate_copper_ore", 2.667d),
			IdTagValue.newId("iguanatweaksreborn:poor_deepslate_iron_ore", 3d),
			IdTagValue.newId("iguanatweaksreborn:poor_deepslate_gold_ore", 3.333d),
			IdTagValue.newId("iguanatweaksreborn:rich_deepslate_copper_ore", 5.333d),
			IdTagValue.newId("iguanatweaksreborn:rich_deepslate_iron_ore", 6d),
			IdTagValue.newId("iguanatweaksreborn:rich_deepslate_gold_ore", 6.666d),
