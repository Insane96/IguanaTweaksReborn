...
import insane96mcp.iguanatweaksreborn.network.message.ServerboundSetSRBeacon;
...
public class SRBeaconScreen extends AbstractContainerScreen<SRBeaconMenu> {
    static final ResourceLocation BEACON_LOCATION = new ResourceLocation(IguanaTweaksReborn.RESOURCE_PREFIX + "textures/gui/container/beacon.png");
