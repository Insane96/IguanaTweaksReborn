...
public class DataPacks extends Feature {
    ...
    public DataPacks(Module module, boolean enabledByDefault, boolean canBeDisabled) {
        ...
        IntegratedDataPacks.INTEGRATED_DATA_PACKS.add(new IntegratedDataPacks.IntegratedDataPack(PackType.SERVER_DATA, "hardcore_torches", net.minecraft.network.chat.Component.literal("IT Reborn Hardcore Torches"), () -> hardcoreTorches));
        IntegratedDataPacks.INTEGRATED_DATA_PACKS.add(new IntegratedDataPacks.IntegratedDataPack(PackType.SERVER_DATA, "cheaper_chains", net.minecraft.network.chat.Component.literal("IT Reborn Cheaper Chains"), () -> cheaperChains));
        IntegratedDataPacks.INTEGRATED_DATA_PACKS.add(new IntegratedDataPacks.IntegratedDataPack(PackType.SERVER_DATA, "misc_tweaks", net.minecraft.network.chat.Component.literal("IT Reborn Misc Tweaks"), () -> miscTweaks));
        IntegratedDataPacks.INTEGRATED_DATA_PACKS.add(new IntegratedDataPacks.IntegratedDataPack(PackType.SERVER_DATA, "cheaper_rails", net.minecraft.network.chat.Component.literal("IT Reborn Cheaper Rails"), () -> cheaperRails));
        IntegratedDataPacks.INTEGRATED_DATA_PACKS.add(new IntegratedDataPacks.IntegratedDataPack(PackType.SERVER_DATA, "no_nether_roof", net.minecraft.network.chat.Component.literal("IT Reborn No Nether Roof"), () -> disableNetherRoof));
    }
}
