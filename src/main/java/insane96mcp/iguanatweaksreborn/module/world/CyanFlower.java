...
public class CyanFlower extends Feature {
    ...
    public static final RegistryObject<Block> POTTED_FLOWER = ITRRegistries.BLOCKS.register("potted_cyan_flower", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, () -> FLOWER.block().get(), BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM)));
