...
import insane96mcp.iguanatweaksreborn.command.SRCommand;
import insane96mcp.iguanatweaksreborn.data.generator.*;
import insane96mcp.iguanatweaksreborn.data.generator.client.SRBlockModelsProvider;
import insane96mcp.iguanatweaksreborn.data.generator.client.SRBlockStatesProvider;
import insane96mcp.iguanatweaksreborn.data.generator.client.SRItemModelsProvider;
...
import insane96mcp.iguanatweaksreborn.module.combat.fletching.dispenser.SRArrowDispenseBehaviour;
...
import insane96mcp.iguanatweaksreborn.setup.SRCommonConfig;
import insane96mcp.iguanatweaksreborn.setup.SRPackSource;
...
public class IguanaTweaksReborn
{
    ...
    public static final RecipeBookType MULTI_ITEM_BLASTING_RECIPE_BOOK_TYPE = RecipeBookType.create(IguanaTweaksReborn.RESOURCE_PREFIX + "multi_item_blasting");
    public static final RecipeBookType MULTI_ITEM_SOUL_BLASTING_RECIPE_BOOK_TYPE = RecipeBookType.create(IguanaTweaksReborn.RESOURCE_PREFIX + "multi_item_soul_blasting");
    public static final RecipeBookType FORGING_RECIPE_BOOK_TYPE = RecipeBookType.create(IguanaTweaksReborn.RESOURCE_PREFIX + "forging");
    public static final RecipeBookType FLETCHING_RECIPE_BOOK_TYPE = RecipeBookType.create(IguanaTweaksReborn.RESOURCE_PREFIX + "fletching");
    ...
    public void gatherData(GatherDataEvent event) {
        ...
        SRBlockTagsProvider blockTags = new SRBlockTagsProvider(generator.getPackOutput(), lookupProvider, IguanaTweaksReborn.MOD_ID, existingFileHelper);
        generator.addProvider(event.includeServer(), blockTags);
        generator.addProvider(event.includeServer(), new SRItemTagsProvider(generator.getPackOutput(), lookupProvider, blockTags.contentsGetter(), IguanaTweaksReborn.MOD_ID, existingFileHelper));
        generator.addProvider(event.includeServer(), new SRDamageTypeTagsProvider(generator.getPackOutput(), lookupProvider, IguanaTweaksReborn.MOD_ID, existingFileHelper));
